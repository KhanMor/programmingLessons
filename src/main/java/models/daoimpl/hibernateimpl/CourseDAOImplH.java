 ...
 * CRUD с курсами через JPA
 */
@Repository("courseDAO")
public class CourseDAOImplH implements SuperDAO<Course> {
    private static final Logger logger = Logger.getLogger(CourseDAOImplH.class);
